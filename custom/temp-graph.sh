...
cat > /jffs/var/www/device-map/router_status.asp << EOF
...
var coreTmp_2_array = new Array(array_size);
var coreTmp_5_array = new Array(array_size);
var coreTmp_cpu_array = new Array(array_size);
for (i = 0; i < array_size; i++) {
coreTmp_2_array[i] = 151;
coreTmp_5_array[i] = 151;
coreTmp_cpu_array[i] = 151;
}
/*End*/
function initial(){
generate_cpu_field();
...
var coreTmp_2 = "<% sysinfo(" temperature.2 "); %>".replace("&deg;C", "");
var coreTmp_5 = "<% sysinfo(" temperature.5 "); %>".replace("&deg;C", "");
var coreTmp_cpu = "<% get_cpu_temperature(); %>";
var pt_2 = "";
var pt_5 = "";
var pt_cpu = "";
document.getElementById('coreTemp_2').innerHTML = coreTmp_2 + " &deg;C";
document.getElementById('coreTemp_5').innerHTML = coreTmp_5 + " &deg;C";
document.getElementById('coreTemp_cpu').innerHTML = coreTmp_cpu + " &deg;C";
coreTmp_2_array.push(150 - (coreTmp_2 - 40) * 3);
coreTmp_2_array.splice(0, 1);
coreTmp_5_array.push(150 - (coreTmp_5 - 40) * 3);
coreTmp_5_array.splice(0, 1);
coreTmp_cpu_array.push(150 - (coreTmp_cpu - 40) * 3);
coreTmp_cpu_array.splice(0, 1);
for (i = 0; i < array_size; i++) {
pt_2 += i * 6 + "," + coreTmp_2_array[i] + " ";
pt_5 += i * 6 + "," + coreTmp_5_array[i] + " ";
pt_cpu += i * 6 + "," + coreTmp_cpu_array[i] + " ";
}
document.getElementById('tmp_2_graph').setAttribute('points', pt_2);
document.getElementById('tmp_5_graph').setAttribute('points', pt_5);
document.getElementById('tmp_cpu_graph').setAttribute('points', pt_cpu);
}
...
<td>
<div>
<table width="98%" border="1" align="center" cellpadding="4" cellspacing="0" class="table1px" style="margin-top: 5px;">
<tr>
<td colspan="3">
...
<td>
<div>2.4 GHz</div>
<div id="coreTemp_2" style="color: #FF9000;"></div>
</td>
<td>
<div>5 GHz</div>
<div id="coreTemp_5" style="color: #33CCFF;"></div>
</td>
<td>
<div>CPU</div>
<div id="coreTemp_cpu" style="color: #00FF33;"></div>
</td>
</tr>
<tr style="height:100px;" class="IE8HACK">
<td colspan="3">
<div style="margin:0px 11px 0px 11px;background-color:black;">
<svg width="270px" height="150px">
<g>
<line stroke-width="1" stroke-opacity="1" stroke="rgb(255,255,255)" x1="0" y1="0%" x2="100%" y2="0%" />
<line stroke-width="1" stroke-opacity="0.2" stroke="rgb(255,255,255)" x1="0" y1="20%" x2="100%" y2="20%" />
<line stroke-width="1" stroke-opacity="0.2" stroke="rgb(255,255,255)" x1="0" y1="40%" x2="100%" y2="40%" />
<line stroke-width="1" stroke-opacity="0.2" stroke="rgb(255,255,255)" x1="0" y1="60%" x2="100%" y2="60%" />
<line stroke-width="1" stroke-opacity="0.2" stroke="rgb(255,255,255)" x1="0" y1="80%" x2="100%" y2="80%" />
<line stroke-width="1" stroke-opacity="1" stroke="rgb(255,255,255)" x1="0" y1="100%" x2="100%" y2="100%" />
</g>
<g>
<text font-family="Verdana" fill="#FFFFFF" font-size="8" x="2" y="5%">90 &deg;C</text>
<text font-family="Verdana" fill="#FFFFFF" font-size="8" x="2" y="22%">80 &deg;C</text>
<text font-family="Verdana" fill="#FFFFFF" font-size="8" x="2" y="42%">70 &deg;C</text>
<text font-family="Verdana" fill="#FFFFFF" font-size="8" x="2" y="62%">60 &deg;C</text>
<text font-family="Verdana" fill="#FFFFFF" font-size="8" x="2" y="82%">50 &deg;C</text>
<text font-family="Verdana" fill="#FFFFFF" font-size="8" x="2" y="98%">40 &deg;C</text>
</g>
<line stroke-width="1" stroke-opacity="1" stroke="rgb(0,0,121)" x1="0" y1="0%" x2="0" y2="100%" id="tick1" />
<line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="30" y1="0%" x2="30" y2="100%" id="tick2" />
<line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="60" y1="0%" x2="60" y2="100%" id="tick3" />
...
<line stroke-width="1" stroke-opacity="0.3" stroke="rgb(40,255,40)" x1="240" y1="0%" x2="240" y2="100%" id="tick9" />
<line stroke-width="1" stroke-opacity="1" stroke="rgb(0,0,121)" x1="270" y1="0%" x2="270" y2="100%" id="tick10" />
<polyline id="tmp_2_graph" style="fill:none;stroke:#FF9000;stroke-width:1;width:200px;" points=""></polyline>
<polyline id="tmp_5_graph" style="fill:none;stroke:#33CCFF;stroke-width:1;width:200px;" points=""></polyline>
<polyline id="tmp_cpu_graph" style="fill:none;stroke:#00FF33;stroke-width:1;width:200px;" points=""></polyline>
</svg>
</div>
</td>
</tr>
