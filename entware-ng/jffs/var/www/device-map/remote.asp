...
function initial(){
if(re_status == -1){
showtext(document.getElementById("Connstatus"), "<#255#>");
document.getElementById("remoteIP_tr").style.display = "none";
setTimeout("set_re_status();",6000);
}
else
set_re_status();
document.getElementById("remoteIP_span").innerHTML = (remoteIP == "")?"<#792#>":remoteIP;
}
function set_re_status(){
re_status = parent.getConnectingStatus();
if(re_status == 2){
showtext(document.getElementById("Connstatus"), "<#68#>");
document.getElementById("remoteIP_tr").style.display = "";
}
else{
showtext(document.getElementById("Connstatus"), "<#889#>");
document.getElementById("remoteIP_tr").style.display = "none";
}
}
function sbtnOver(o){
...
<tr>
<th><#794#></th>
<td><input type="button" class="sbtn" value="<#844#>" onclick="javascript:parent.location.href='../survey.htm';" onmouseover="sbtnOver(this);" onmouseout="sbtnOut(this);"></td>
</tr>
</table>
</body>
</html>
