...
switch (rssi_t) {
case 1:
connectModeTip = "<#471#>: <#264#>\n";
break;
case 2:
connectModeTip = "<#471#>: <#265#>\n";
break;
case 3:
connectModeTip = "<#471#>: <#266#>\n";
break;
case 4:
connectModeTip = "<#471#>: <#267#>\n";
break;
}
if(stainfo_support) {
if(clientObj.curTx != "")
...
connectModeTip += "<#569#>: " + clientObj.wlConnectTime + "";
}
}
if(parent.sw_mode != 4) {
...
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#931#><img src="/images/InternetScan.gif"></div>';
else
clientHtmlTd = '<div style="color:#FC0;height:30px;text-align:center;margin-top:15px"><#1326#></div>';
}
...
var overlibStr = "<p><#174#>:</p>" + client.mac.toUpperCase();
if(client.ssid)
overlibStr += "<p>SSID:</p>" + client.ssid.replace(/"/g, '&quot;');
if(client.isLogin)
overlibStr += "<p>Logged In User:</p>YES";
if(client.isPrinter)
overlibStr += "<p><#933#></p>YES";
if(client.isITunes)
overlibStr += "<p><#932#></p>YES";
if(client.isWL > 0){
overlibStr += "<p><#2234#>:</p>" + wl_nband_title[client.isWL-1] + " (" + client.rssi + " dBm)";
if(stainfo_support) {
overlibStr += "<p>Tx Rate:</p>" + ((client.curTx != "") ? client.curTx : "-");
overlibStr += "<p>Rx Rate:</p>" + ((client.curRx != "") ? client.curRx : "-");
overlibStr += "<p><#569#>:</p>" + client.wlConnectTime;
}
}
return overlibStr;
}
...
<input type="button" id="refresh_list" class="button_gen" value="<#900#>" style="margin-left:70px;">
<script>
