...
var Days = ~~(total / 24);
if (Days != 0)
value += Days.toString() + " <#920#> ";
if (Hours != 0)
value += Hours.toString() + " <#1262#> ";
if (Minutes != 0)
value += Minutes.toString() + " <#1516#> ";
if (Seconds != 0)
value += Seconds.toString() + " <#1805#>";
return value;
}
function initial(){
flash_button();
...
showtext(document.getElementById("dualwan_mode"), "<#1031#>");
loadBalance_form(unit);
}
else{
showtext(document.getElementById("dualwan_mode"), "<#1030#>");
...
if(lanproto == "static")
showtext(document.getElementById("LanProto"), "<#54#>");
else
showtext(document.getElementById("LanProto"), "<#53#>");
...
wanlink_type_conv = "<#53#>";
else if(wanlink_type_conv == "static")
wanlink_type_conv = "<#54#>";
...
<p class="formfonttitle_nwm" style="float:left;width:98px;"><#200#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:98px;"><#1021#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2215#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1029#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1032#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" ><#71#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2206#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#134#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#2405#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1781#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1393#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1467#></p>
...
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#95#></p>
<input type="button" class="button_gen_long" onclick="goToDualWAN();" value="<#844#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
<img style="margin-top:5px;" src="/images/New_ui/networkmap/linetwo2.png">
</td>
</tr>
<tr id="goSetting" style="display:none">
<td height="30" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:116px;"><#847#></p>
<input type="button" class="button_gen_long" onclick="goToWAN();" value="<#844#>" style="position:absolute;right:25px;margin-top:-10px;margin-left:115px;">
</td>
</tr>
<!--tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:98px; "><#282#></p>
<input type="button" class="button_gen" value="<#844#>" onclick="javascript:goQIS();">
</td>
</tr-->
</table>
...
<p class="formfonttitle_nwm"><#485#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1378#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#132#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1269#></p>
...
<br />
<input type="button" class="button_gen" onclick="gotoSiteSurvey();" value="<#379#>" style="float:right;">
<!--input type="button" class="button_gen" onclick="manualSetup();" value="<#181#>" style="float:right;"-->
