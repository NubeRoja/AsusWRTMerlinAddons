...
<p class="formfonttitle_nwm"><#1726#></p>
...
<tr>
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm"><#1732#></p>
...
<td style="padding:5px 10px 5px 15px;">
<p class="formfonttitle_nwm" id="monoP" style="width:138px;"><#1731#></p>
<input id="monoBtn" type="button" class="button_gen" value="<#2284#>" onclick="cleanTask();">
...
<li><#1724#></li>
<li>
<a id="faq" href="" target="_blank" style="text-decoration:underline;"><#1731#> FAQ</a>
</li>
</ul>
</div>
</form>
