...
if(progressBar >= 5)
progressBar =5;
document.getElementById('scan_message').innerHTML = "<#962#>";
}
...
progressBar = 15;
document.getElementById('scan_message').innerHTML = "<#973#>";
}
...
progressBar = 90;
document.getElementById('scan_message').innerHTML = "<#965#>";
}
else if(scan_status == 5 && stopScan == 0){
if(progressBar <= 90)
progressBar = 91;
document.getElementById('scan_message').innerHTML = "<#958#>";
}
else{
...
<div class="font_style" style="margin-left:10px;margin-bottom:5px;margin-top:10px;"><#956#></div>
<div >
...
<input id="btn_scan" type="button" class="button_gen" onclick="go_scan();" value="<#379#>">
...
<tr>
<td style="background-color:#4D595D;" >
<div class="font_style" style="margin-left:12px;margin-top:10px;"><#970#></div>
<img style="margin-top:5px;margin-left:10px; *margin-top:-5px;" src="/images/New_ui/networkmap/linetwo2.png">
<div style="margin-left:10px;">
<table>
<tr class="font_style">
<td style="width:100px;">
<div style="margin-bottom:5px;" ><#959#></div>
<select name="diskmon_freq" onchange="freq_change();" class="input_option">
<option value="0" <% nvram_match("diskmon_freq", "0", "selected"); %>><#840#></option>
<option value="1" <% nvram_match("diskmon_freq", "1", "selected"); %>><#963#></option>
<option value="2" <% nvram_match("diskmon_freq", "2", "selected"); %>><#975#></option>
<option value="3" <% nvram_match("diskmon_freq", "3", "selected"); %>><#955#></option>
</select>
</td>
<td >
<div id="date_field">
...
<td>
<div id="week_field">
<div style="margin-bottom:5px"><#974#></div>
...
<div style="margin-top:20px;margin-bottom:10px;" align="center">
<input type="button" class="button_gen" onclick="apply_schedule();" value="<#74#>">
