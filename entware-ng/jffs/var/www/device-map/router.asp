...
document.form.wl_wpa_psk.value = "<#2233#>";
*/
limit_auth_method();
...
var modedesc = visible ? get_yadns_modedesc(i) + ": <#1202#> " + yadns_clients[i] : "";
...
if(document.form.wl_wpa_psk.value == "<#2233#>")
...
<input type="hidden" name="wl_key_type" value="<% nvram_get("wl_key_type"); %>"><input type="hidden" name="wl_key_org" value="<% nvram_char_to_ascii("WLANConfig11b", "wl_key"); %>">
...
<input type="hidden" name="wl_nmode_x" value="<% nvram_get("wl_nmode_x"); %>"><input type="hidden" name="wps_band" value="<% nvram_get("wps_band"); %>">
...
<p class="formfonttitle_nwm" ><#339#></p>
...
<tr>
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#2243#></p>
...
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#556#></p>
...
<td style="padding:5px 10px 0px 10px; *padding:1px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#560#></p>
...
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#2394#>
</p>
...
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" style="float:left;"><#2234#></p>
...
<input id="applySecurity" type="button" class="button_gen" value="<#74#>" onclick="submitForm();" style="margin-left:90px;">
</td>
</tr>
<tr>
...
<tr>
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" ><#1683#></p>
...
<tr>
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >LAN <#174#></p>
...
<tr id="macaddr_wl2">
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl2_title">2.4GHz </span><#174#></p>
...
<tr id="macaddr_wl5">
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl5_title">5GHz </span><#174#></p>
...
<td style="padding:5px 10px 0px 10px;">
<p class="formfonttitle_nwm" >Wireless <span id="macaddr_wl5_2_title">5GHz-2 </span><#174#></p>
