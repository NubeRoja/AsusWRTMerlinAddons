...
<span id="span1" style="cursor:pointer;font-weight: bolder;"><#960#></span>
</div>
</td>
<td>
<div id="t1" class="tab_NW" align="center" style="font-weight: bolder;margin-right:2px;" onclick="location.href='disk_utility.asp'">
<span id="span1" style="cursor:pointer;font-weight: bolder;"><#953#></span>
</div>
</td>
</table>
</td>
...
<p class="formfonttitle_nwm"><#1594#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#813#>:</p>
...
<tr>
<td style="padding:5px 10px 0px 15px;">
<p class="formfonttitle_nwm"><#1958#>:</p>
...
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#499#>:</p>
<input type="button" class="button_gen" onclick="goUPnP();" value="<#844#>" >
<img style="margin-top:5px;" src="/images/New_ui/networkmap/linetwo2.png">
</td>
</tr>
<tr id="aidisk_hyperlink">
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px;"><#675#>:</p>
<input type="button" class="button_gen" onclick="gotoAidisk();" value="<#844#>" >
<img style="margin-top:5px;" src="/images/New_ui/networkmap/linetwo2.png">
</td>
</tr>
...
<input type="button" class="button_gen" onclick="gotoDM();" value="<#844#>" >
<img style="margin-top:5px;" src="/images/New_ui/networkmap/linetwo2.png">
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; "><#1800#>:</p>
<input id="show_remove_button" class="button_gen" type="button" class="button" onclick="remove_disk_call();" value="<#845#>">
<div id="show_removed_string" style="display:none;"><#1798#></div>
<img style="margin-top:5px;" src="/images/New_ui/networkmap/linetwo2.png">
</td>
</tr>
</table>
...
<tr>
<td height="50" style="padding:10px 15px 0px 15px;">
<p class="formfonttitle_nwm" style="float:left;width:138px; " onmouseover="parent.overHint(24);" onmouseout="parent.nd();"><#2356#></p>
...
<li><#976#><a href="/" target="_parent"><#977#></a><#978#></li>
</ul>
</div>
